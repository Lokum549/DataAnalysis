...
*(Порада: зробіть скріншот вашої працюючої програми з вашим обличчям та якимось фільтром, збережіть його в папку проєкту як `demo.png` та розкоментуйте рядок нижче)*
<!-- ![Демонстрація роботи програми](demo.png) -->
...
1. Відкрийте термінал та клонуйте репозиторій:
   ```bash
   git clone [https://github.com/ВашЛогін/ВашРепозиторій.git](https://github.com/ВашЛогін/ВашРепозиторій.git)
